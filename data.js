const data = {
  ...
  ref_text:
    "Copy your referral link below and send it to your friends. For every purchase made using this link, you’ll receive 5% of the purchase amount as USDT.",
  ...
  "airdrop-li-text":
    "We’re giving away $50,000 worth of $WSM tokens split between 5 lucky degens in a very generous Wall Street Memes airdrop. Enter below and make sure you’re in it to win it!",
  how_to_buy_page_title: "Buying Guide For Beginners",
  how_to_buy_page_desc:
    "Leave your details below and we’ll contact you to discuss purchasing $WSM.",
  sign_up: "Sign Up",
  ...
  roadmap_q1_para1_title: "🚀 Smart Contract Development:",
  roadmap_q1_para2_title: "🌐 Community Building:",
  roadmap_q1_para3_title: "📣 Branding and Marketing:",
  roadmap_q1_para4_title: "💥 Merchandise and Swag:",
  roadmap_q2_para1_title: "🚀 Token Launch:",
  roadmap_q2_para2_title: "🤝 Partnerships:",
  roadmap_q2_para3_title: "💰 Token Listings:",
  roadmap_q2_para4_title: "💎 Exchange Listings:",
  roadmap_q2_para5_title: "🌍 Awareness Campaigns:",
  roadmap_q3_para1_title: "🔒 Gated Community:",
  roadmap_q3_para2_title: "🌟 Market Cap Goal:",
  roadmap_q3_para3_title: "🚀 Tier 1 CEX Listings:",
  ...
  how_to_desc1:
    "Are you a first-time buyer of crypto tokens? Not to worry, we’ve put together a guide on how to set up a personal wallet and buy $WSM tokens right here. Our presale is being hosted on our website, so all you need is a browser-based or mobile app wallet.",
  how_to_desc2:
  ...
  how_to_desk_desc_6:
    "After buying $WSM tokens, you can see how much you’ll be able to claim on the website’s home page. After the presale, once claiming is activated, you’ll be able to claim your $WSM tokens to the same MetaMask wallet address you used to contribute.",
  how_to_desk_7: "Import $WSM to MetaMask",
  how_to_desk_desc_7:
    "To view your token balance within MetaMask, import the $WSM token to your wallet. Open the MetaMask browser extension, scroll all the way down, click ‘Import Tokens’ and paste in the $WSM contract address: 0xb62e45c3df611dce236a6ddc7a493d79f9dfadef",
  ...
  how_to_phone_desc_5:
    "After buying $WSM tokens, you can see how much you’ll be able to claim on the website’s home page. After the presale, once claiming is activated, you’ll be able to claim your $WSM tokens to the same Trust Wallet address you used to contribute.",
  how_to_phone_6: "Add $WSM to Trust Wallet",
  how_to_phone_desc_6:
    "To view your token balance within Trust Wallet, add the $WSM token to your wallet. Click on the dotted button in the top-right of the screen, followed by ‘Add Custom Token’. Paste the $WSM contract address: 0xb62e45c3df611dce236a6ddc7a493d79f9dfadef",
  step1: "Step 1:",
  step2: "Step 2:",
  step3: "Step 3:",
  ...
  how_to_wsm_step1: "Click on ‘Connect Wallet’ to start the purchase process.",
  how_to_wsm_step2:
  ...
  how_to_buy_eth_1:
    "Select the ETH or BNB tab and enter the amount of ETH or BNB you wish to swap for $WSM tokens. Click ‘Buy Now’ to proceed.",
  how_to_buy_eth_2:
    "Review the transaction details and gas fee when the MetaMask window pops up. Click ‘Confirm’ when you’re happy to proceed.",
  how_to_buy_eth_3:
    "After the transaction goes through, you’ll see a confirmation of your successful purchase. You’ll be able to claim your $WSM tokens to the same wallet when claiming is ready.",
  how_to_buy_usdt: "Buying with USDT",
  how_to_buy_usdt_1:
    "Select the USDT tab (ERC-20 for Ethereum network or BEP-20 for BNB Chain) and enter the amount of USDT you wish to swap for $WSM tokens. Click ‘Buy Now’ to proceed.",
  how_to_buy_usdt_2:
    "Before you’re able to proceed, you’ll be prompted to authorize the use of USDT in your wallet. Input a spending cap that you’re comfortable with and approve to continue the transaction.",
  how_to_buy_usdt_3:
    "Review the transaction details and gas fee when the MetaMask window pops up. Click ‘Confirm’ when you’re happy to proceed.",
  how_to_buy_usdt_4:
    "After the transaction goes through, you’ll see a confirmation of your successful purchase. You’ll be able to claim your $WSM tokens to the same wallet when claiming is ready.",
  ...
  how_to_buy_card_1:
    "Select the CARD tab and enter the amount in USD you wish to swap for $WSM tokens. Click ‘Buy Now’ to proceed. You’ll need to connect the crypto wallet you want your tokens to be sent to.",
  how_to_buy_card_2:
  ...
  how_to_buy_wallet_1:
    "If you don’t have a wallet, select this option when trying to connect to review your options and download a new wallet.",
  how_to_buy_wallet_2:
    "Select ‘I don’t have a wallet’ and you’ll be directed to the official Ethereum website to see your wallet options. For new crypto users, we recommend MetaMask if you use a laptop and Trust Wallet if you prefer using your phone. Remember to also do your own research.",
  ...
  media3_title: "🔥IS THIS THE NEXT 100X MEME COIN?!",
  nav_media: "Media",
  media4_title:
